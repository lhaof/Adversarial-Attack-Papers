...
def get_arguments():
	...
	parser.add_argument('-prefix'           , type=str ,  default= 'rfcn_v1')
	...
	parser.add_argument('-net_weights'      , type=str ,  default= './models/fine-tune/Refcn-8s_iter_100000.caffemodel')
	parser.add_argument('-net_proto'        , type=str ,  default= 'solver_rfcn.prototxt')
